...
`cordon` is a defensive security tool, so we take its own correctness seriously.
...
If you find a way to slip an injection past `cordon`, or a defect in the egress
firewall, please report it.

- For a **detection bypass** (a payload cordon should flag but does not),
...
- For a **sensitive vulnerability** (for example, a way to make cordon itself
...
Please include: cordon version, a minimal input that reproduces the problem,
what you expected, and what happened.

## Scope and expectations

`cordon` is one layer of defense in depth, not a guarantee. It is a heuristic
